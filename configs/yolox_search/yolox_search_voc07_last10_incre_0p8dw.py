...
previous_num_classes = 10
# model settings
model = dict(
    type='SearchableYOLOX_KD_Incre',
    ori_num_classes=previous_num_classes,
    ori_checkpoint_file='work_dirs/yolox_search_voc07_first10/epoch_300.pth',
    ori_config_file='configs/yolox_search/yolox_search_voc07_first10.py',
    dist_loss_weight=0.8,
    dist_bbox=True,
    is_kd=False,
...
train_dataset = dict(
    ...
    dataset=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/voc07_trainval_sel_last_10_cats.json',
