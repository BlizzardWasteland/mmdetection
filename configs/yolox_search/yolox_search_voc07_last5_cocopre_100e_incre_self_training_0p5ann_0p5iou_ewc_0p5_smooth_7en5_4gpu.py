...
model = dict(
    ...
    ori_checkpoint_file='work_dirs/yolox_search_voc07_first15_cocopre_100e_4gpu/epoch_100.pth',
    ori_config_file='configs/yolox_search/yolox_search_voc07_first15.py',
    ori_weighted_file='work_dirs/yolox_search_voc07_first15_ewc_weight_cocopre/ewc_weight.pth',
    lamda=0.5,
    anno_threshold=0.5,
    iou_threshold=0.5,
    smooth=True,
