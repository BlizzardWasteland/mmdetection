...
model = dict(
    ...
    ori_checkpoint_file='work_dirs/yolox_search_voc07_shipaug_first10/epoch_300.pth',
    ori_config_file='configs/yolox_search/yolox_search_voc07_shipaug_first10.py',
    dist_loss_weight=1,
    is_kd=False,
