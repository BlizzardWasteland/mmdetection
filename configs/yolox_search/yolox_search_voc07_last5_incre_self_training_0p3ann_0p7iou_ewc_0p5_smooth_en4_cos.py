...
model = dict(
    ...
    ori_checkpoint_file='work_dirs/yolox_search_voc07_first15_cos/epoch_300.pth',
    ori_config_file='configs/yolox_search/yolox_search_voc07_first15_cos.py',
    ori_weighted_file='work_dirs/yolox_search_voc07_first15_ewc_weight_cos/ewc_weight.pth',
    lamda=0.5,
    anno_threshold=0.3,
    iou_threshold=0.7,
    smooth=True,
    ...
    neck=dict(
        ...
        act_cfg=dict(type=act_type)),
    bbox_head=dict(
        type='SearchableYOLOXHeadIncreCos',
        ori_num_classes=15,
        num_classes=20,
