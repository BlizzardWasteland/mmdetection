...
train_dataset = dict(
    ...
    dataset=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/voc07_trainval_sel_first_15_cats.json',
...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/voc07_test_sel_first_15_cats.json',
        img_prefix='data/VOCdevkit/',
...
load_from='work_dirs/yolox_search_coco_4gpu/epoch_300.pth'
