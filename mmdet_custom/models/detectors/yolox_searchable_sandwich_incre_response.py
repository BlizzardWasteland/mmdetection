...
class SearchableYOLOX_KD_Incre_Response(SearchableYOLOX_KD):
    def __init__(self,
                 ori_num_classes,
                 ori_checkpoint_file,
                 ori_config_file,
    ...
    def forward_train(self, img,
        ...
        respone_kd_loss = self.bbox_head.loss_response(cls_score, bbox_pred, objectness, cls_score_teacher, bbox_pred_teacher, objectness_teacher)
        # losses['loss_kd_response'] = respone_kd_loss
        losses.update(respone_kd_loss)
        # i = 0
