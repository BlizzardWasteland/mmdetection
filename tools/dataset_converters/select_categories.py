...
def sel_cat(anno_file, sel_num):
    ...
    # writing results
    fp = open(os.path.splitext(anno_file)[0] + '_sel_first_{}_cats.json'.format(sel_num), 'w')
    ...
    sel_dataset['images'] = sel_images
    # writing results
    fp = open(os.path.splitext(anno_file)[0] + '_sel_last_{}_cats.json'.format(20-sel_num), 'w')
    json.dump(sel_dataset, fp)


if __name__ == "__main__":
    # anno_file = '/data-nas/sy/coco/annotations/instances_val2017.json'
    # anno_file = 'data/my_voc/annotations/voc07_test.json'
    sel_num = 15
    # sel_num = 10
    anno_file = '/home/wangsiyu/mmdetection/data/my_voc/annotations/voc07_trainval.json'
    sel_cat(anno_file, sel_num)

    anno_file = '/home/wangsiyu/mmdetection/data/my_voc/annotations/voc07_test.json'
    sel_cat(anno_file, sel_num)
