...
def find_repeat(first_cats_json, last_cats_json):
    ...
    print(len(intersections),'/',(len(first_cats_image_id_set)+len(last_cats_image_id_set))) # 34507
...
if __name__ == "__main__":
    first_cats_json = '/data1/linzhiwei/project/mmdetection/data/my_voc/annotations/voc07_trainval_sel_first_10_cats.json'
    last_cats_json = '/data1/linzhiwei/project/mmdetection/data/my_voc/annotations/voc07_trainval_sel_last_10_cats.json'
