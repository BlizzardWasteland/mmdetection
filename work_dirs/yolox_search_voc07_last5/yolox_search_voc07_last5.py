...
train_dataset = dict(
    ...
    dataset=dict(
        ...
        ann_file='data/my_voc/annotations/voc07_trainval_sel_last_5_cats.json',
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type='CocoDatasetContinual',
            ann_file=
            'data/my_voc/annotations/voc07_trainval_sel_last_5_cats.json',
            img_prefix='data/VOCdevkit/',
            pipeline=[
                dict(type='LoadImageFromFile'),
                dict(type='LoadAnnotations', with_bbox=True)
    ...
    val=dict(
        type='CocoDatasetContinual',
        ann_file='data/my_voc/annotations/voc07_test.json',
        img_prefix='data/VOCdevkit/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
work_dir = './work_dirs/yolox_search_voc07_last5'
auto_resume = False
gpu_ids = [0]
