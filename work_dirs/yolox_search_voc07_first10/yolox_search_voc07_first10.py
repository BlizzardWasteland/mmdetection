...
train_dataset = dict(
    ...
    dataset=dict(
        ...
        ann_file=
        'data/my_voc/annotations/voc07_trainval_sel_first_10_cats.json',
...
data = dict(
    ...
    val=dict(
        type='CocoDatasetContinual',
        ann_file='data/my_voc/annotations/voc07_test_sel_first_10_cats.json',
        img_prefix='data/VOCdevkit/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
work_dir = './work_dirs/yolox_search_voc07_first10'
auto_resume = False
gpu_ids = [0]
